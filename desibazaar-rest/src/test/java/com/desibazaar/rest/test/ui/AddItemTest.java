...
public class AddItemTest {
	...
	public void postItem() {
		...
		WebElement plus_element = driver.findElement(By
		...
		image_element
				.sendKeys("/Users/akshaybodhankar/Documents/desibazaar/desibazaar-web/src/main/webapp/img/abacus.jpg");
		...
		WebElement itemName_element = driver.findElement(By.name(""));
		...
		// WebElement element1 =
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/ng-view/div[2]/div/div/div[2]/h3/a")));
		// System.out.println();
