...
public class AuctionServiceTest {
	...
	public void getAuction() {
		...
		assertEquals("The second generation of the iPad, the iPad 2, is a tablet computer designed, developed and marketed by Apple Inc. "
				+ "It serves as a platform for audio-visual media including books, news, movies, music, games, presentations and web content.", item.getDescription());
	...
	public void getCategories() {
		...
		assertEquals("A smartphone (or smart phone) is a mobile phone with an advanced mobile operating system.[1][2][3]"
				+ " They typically combine the features of a cell phone with those of other popular mobile devices", cats.get(0).getDescription());
		assertEquals("SmartPhones", cats.get(0).getName());
		assertEquals("A laptop or a notebook is a portable personal computer with a clamshell form factor, suitable for mobile use", cats.get(1).getDescription());
